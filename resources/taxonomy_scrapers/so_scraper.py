# download so-simple.json from
# https://github.com/The-Sequence-Ontology/SO-Ontologies/tree/master/Ontology_Files
# or pull from
# https://github.com/SynBioDex/SBOLExplorer/blob/master/flask/so-simplified.json
